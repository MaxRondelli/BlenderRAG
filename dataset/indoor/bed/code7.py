...
HEADBOARD_HEIGHT = 1.40  # 140cm tall headboard (taller)
FOOTBOARD_HEIGHT = 0.60  # 60cm tall footboard
FRAME_THICKNESS = 0.08  # 8cm thick frame (thicker)
...
def create_headboard():
    """
    Creates a padded headboard with button tufting pattern
    """
    bpy.ops.mesh.primitive_cube_add(
    ...
    # Add subdivision for tufting detail
    ...
    # Apply upholstery material (cream color)
    create_fabric_material(headboard, color=(0.9, 0.85, 0.75, 1.0))
...
def create_mattress():
    ...
    create_fabric_material(mattress, color=(0.96, 0.94, 0.90, 1.0))
...
def create_pillow(position, rotation=0):
    ...
    # Apply pillow material (cream color)
    create_fabric_material(pillow, color=(0.95, 0.92, 0.85, 1.0), roughness=0.7)
...
def create_wood_material(obj):
    ...
    # Light oak wood color
    principled_node.inputs['Base Color'].default_value = (0.75, 0.65, 0.45, 1.0)
