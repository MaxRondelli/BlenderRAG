...
MATTRESS_HEIGHT = 0.22  # 22cm thick mattress (slightly lower)
FRAME_HEIGHT = 0.25  # Lower frame base height from ground
HEADBOARD_HEIGHT = 0.85  # 85cm tall headboard (lower profile)
...
def create_mattress():
    ...
    create_fabric_material(mattress, color=(0.98, 0.95, 0.88, 1.0))
...
def create_pillow(position, rotation=0):
    ...
    create_fabric_material(pillow, color=(0.95, 0.92, 0.85, 2.0), roughness=0.6)
...
def create_wood_material(obj):
    ...
    principled_node.inputs['Base Color'].default_value = (0.82, 0.65, 0.45, 1.0)
...
def create_fabric_material(obj, color=(0.9, 0.9, 0.9, 1.0), roughness=0.7):
    """
