...
def create_headboard():
    ...
    create_fabric_material(headboard, color=(0.92, 0.88, 0.82, 1.0))  # Cream color
...
def create_pillow(position, rotation=0):
    ...
    create_fabric_material(pillow, color=(0.92, 0.88, 0.82, 1.0), roughness=0.6)
    
    return pillow

def create_wood_material(obj):
    """
    Creates a wood material for the bed frame
    """
