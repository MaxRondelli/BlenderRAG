...
MATTRESS_HEIGHT = 0.25  # 25cm thick mattress
FRAME_HEIGHT = 0.35  # Frame base height from ground
HEADBOARD_HEIGHT = 1.20  # 120cm tall headboard
FOOTBOARD_HEIGHT = 0.60  # 60cm tall footboard
FRAME_THICKNESS = 0.05  # 5cm thick frame
PILLOW_WIDTH = 0.50  # 50cm wide pillow
PILLOW_LENGTH = 0.50  # 70cm long pillow
PILLOW_HEIGHT = 0.15  # 15cm thick pillow (increased thickness)
...
def create_bed_frame():
    ...
    # Apply golden wood material
    create_golden_wood_material(bed_frame)
    
    return bed_frame

def create_headboard():
    """
    Creates a padded headboard with luxury burgundy upholstery
    """
    bpy.ops.mesh.primitive_cube_add(
    ...
    # Apply luxury burgundy upholstery material
    create_luxury_fabric_material(headboard, color=(0.5, 0.1, 0.15, 1.0))  # Rich burgundy
    
    return headboard

def create_footboard():
    """
    Creates a footboard with golden wood finish
    """
    bpy.ops.mesh.primitive_cube_add(
    ...
    # Apply golden wood material
    create_golden_wood_material(footboard)
...
def create_mattress():
    ...
    # Apply cream mattress material
    create_fabric_material(mattress, color=(0.98, 0.96, 0.88, 1.0))  # Cream color
    
    return mattress

def create_pillow(position, rotation=0):
    """
    Creates a thicker pillow with cream color
    """
    bpy.ops.mesh.primitive_cube_add(
        location=position
    )
    ...
    # Apply cream pillow material
    create_fabric_material(pillow, color=(0.98, 0.96, 0.88, 1.0), roughness=0.6)  # Cream color
    
    return pillow

def create_golden_wood_material(obj):
    """
    Creates a golden wood material for the bed frame
    """
    mat = bpy.data.materials.new(name="GoldenWoodMaterial")
    mat.use_nodes = True
    ...
    # Golden wood color
    principled_node.inputs['Base Color'].default_value = (0.45, 0.32, 0.18, 1.0)
...
def create_luxury_fabric_material(obj, color=(0.5, 0.1, 0.15, 1.0), roughness=0.7):
    """
    Creates a luxury fabric material for the headboard
    """
    mat = bpy.data.materials.new(name="LuxuryFabricMaterial")
    mat.use_nodes = True
    nodes = mat.node_tree.nodes
    links = mat.node_tree.links
    ...
    # Luxury fabric properties with velvet-like appearance
...
def create_fabric_material(obj, color=(0.9, 0.9, 0.9, 1.0), roughness=0.8):
    """
    Creates a fabric material for mattress and pillows
    """
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 50)
    print("Luxury bed created successfully!")
    print("=" * 50)
    ...
    print("\nThe luxury bed includes:")
    print("  - Golden wood bed frame with legs")
    print("  - Burgundy upholstered headboard")
    print("  - Golden wood footboard")
    print("  - Cream-colored mattress")
    print("  - 2 Thick cream pillows")
