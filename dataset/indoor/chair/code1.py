...
# -------------------------
# Units (slightly thicker components)
# -------------------------
LEG_HEIGHT = 0.45
SEAT_WIDTH = 0.42
SEAT_DEPTH = 0.40
SEAT_THICKNESS = 0.035  # Increased from 0.03
LEG_THICKNESS = 0.045   # Increased from 0.04
STRETCHER_THICKNESS = 0.03  # Increased from 0.025
BACK_HEIGHT = 0.50
BACK_THICKNESS = 0.025  # Increased from 0.02
SLAT_WIDTH = 0.03       # Increased from 0.025
SLAT_SPACING = 0.04

# -------------------------
# Materials (darker walnut wood)
# -------------------------
...
bsdf.location = (0, 0)
bsdf.inputs['Base Color'].default_value = (0.35, 0.25, 0.18, 1)  # Dark walnut color
bsdf.inputs['Roughness'].default_value = 0.3  # Less rough for more luxury feel
...
print("✅ Dark walnut chair created successfully!")