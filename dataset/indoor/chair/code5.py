...
SEAT_DEPTH = 0.40
SEAT_THICKNESS = 0.03
LEG_THICKNESS = 0.05  # Increased from 0.04
STRETCHER_THICKNESS = 0.025
BACK_HEIGHT = 0.50
BACK_THICKNESS = 0.02
SLAT_WIDTH = 0.025
SLAT_SPACING = 0.045  # Increased from 0.04
...
# Set mahogany color (darker, richer wood tone)
...
# -------------------------
# Back Slats (with increased spacing)
# -------------------------
