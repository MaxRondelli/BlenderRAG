...
def create_ceramic_material():
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.2, 0.4, 0.8, 1.0)  # Vibrant blue
...
for i in range(num_leaves):
    ...
    # Spiral angle with more rotations for denser leaf arrangement
    angle = (i / num_leaves) * math.pi * 6  # More rotations for more leaves
