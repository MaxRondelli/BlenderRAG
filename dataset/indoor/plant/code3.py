...
def create_ceramic_material():
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.2, 0.5, 0.8, 1.0)  # Bright blue
...
for i in range(num_leaves):
    ...
    # Spiral angle
    angle = (i / num_leaves) * math.pi * 5  # More rotations for more leaves
    ...
    # Scale to create leaf shape with some variation
    ...
    leaf.rotation_euler = (
        ...
        0,
        angle + math.radians(random.uniform(-20, 20))  # Face outward with more variation
    )
