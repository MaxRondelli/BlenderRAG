...
# Materials
def create_blue_ceramic_material():
    """Create a vibrant blue ceramic pot material"""
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.15, 0.45, 0.85, 1.0)  # Vibrant blue
...
# Create materials
blue_ceramic_mat = create_blue_ceramic_material()
...
pot.data.materials.append(blue_ceramic_mat)
...
pot_rim.data.materials.append(blue_ceramic_mat)
...
for i in range(num_leaves):
    ...
    # Spiral angle with tighter arrangement
    angle = (i / num_leaves) * math.pi * 5  # More rotations for denser arrangement
