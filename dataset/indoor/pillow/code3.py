...
def create_pillow_material(name="PillowMaterial", base_color=(0.45, 0.12, 0.18)):
    """Create a velvet-like material for the pillow"""
...
def create_pillow(location=(0, 0, 0), size=(1.4, 0.8, 0.2), color=(0.45, 0.12, 0.18)):
    """
    Create a luxurious throw pillow with velvet appearance
