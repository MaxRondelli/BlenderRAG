...
def create_pillow(location=(0, 0, 0), size=(1.2, 0.6, 0.28), color=(0.4, 0.1, 0.15)):
    """
    ...
    simple_deform.angle = math.radians(7)
    ...
    cloth.settings.uniform_pressure_force = 3.5
...
def setup_scene():
    ...
    bpy.ops.mesh.primitive_plane_add(location=(0, 0, -0.15), scale=(3, 3, 1))
