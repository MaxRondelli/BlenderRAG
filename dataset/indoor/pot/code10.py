...
def create_pot(location=(0, 0, 0), radius=0.32, height=0.38):
    """
    Create a realistic copper cooking pot with lid and handles
    ...
    # Inset the top face for thicker wall thickness
    ...
    pot_mat = create_material("PotMaterial", (0.85, 0.45, 0.32), metallic=0.95, roughness=0.15)
    ...
    rim_mat = create_material("RimMaterial", (0.82, 0.42, 0.30), metallic=0.93, roughness=0.18)
    ...
    for i, (hx, hy, hz) in enumerate(handle_positions):
        ...
        handle_mat = create_material(f"PotHandleMat_{i}", (0.88, 0.48, 0.35), metallic=0.92, roughness=0.12)
    ...
    lid_mat = create_material("LidMaterial", (0.83, 0.43, 0.31), metallic=0.94, roughness=0.16)
    ...
    # Brass knob material
    knob_mat = create_material("KnobMaterial", (0.75, 0.55, 0.20), metallic=0.85, roughness=0.25)
    ...
    print(f"Realistic copper cooking pot created at {location}")
    return pot_body
