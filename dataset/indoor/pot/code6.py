...
def create_pot(location=(0, 0, 0), radius=0.32, height=0.38):
    ...
    # Create pot material (copper bronze)
    pot_mat = create_material("PotMaterial", (0.89, 0.55, 0.31), metallic=0.95, roughness=0.12)
    ...
    rim_mat = create_material("RimMaterial", (0.86, 0.52, 0.28), metallic=0.94, roughness=0.14)
    ...
    for i, (hx, hy, hz) in enumerate(handle_positions):
        ...
        # Handle material (polished copper)
        handle_mat = create_material(f"PotHandleMat_{i}", (0.84, 0.49, 0.25), metallic=0.92, roughness=0.16)
    ...
    # Create realistic pot lid - MORE PRONOUNCED DOME
    lid_z = location[2] + height + 0.025
    
    # Lid main body (MORE domed)
    ...
    lid_mat = create_material("LidMaterial", (0.87, 0.53, 0.29), metallic=0.94, roughness=0.13)
