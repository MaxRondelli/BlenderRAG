...
# CABINET MATERIALS - Updated to lighter oak
wood_color = (0.58, 0.47, 0.35, 1)  # Lighter oak wood
wood_metallic = 0.05
wood_roughness = 0.4

door_color = (0.62, 0.51, 0.38, 1)  # Slightly lighter oak for doors
door_metallic = 0.05
door_roughness = 0.35

handle_color = (0.15, 0.15, 0.15, 1)  # Matte black handles
handle_metallic = 0.9
handle_roughness = 0.2

shelf_color = (0.60, 0.49, 0.37, 1)
shelf_metallic = 0.03
shelf_roughness = 0.45
...
# COUNTERTOP - Updated to black granite
counter_height = lower_cabinet_height
counter_thickness = 0.04
countertop_color = (0.12, 0.12, 0.14, 1)  # Black granite
countertop_metallic = 0.8
...
def create_lower_cabinet(name, position, width):
    ...
    # Door handles - now sleek black metal
    handle_height = 0.012
    handle_width = 0.15
    handle_depth = 0.020
...
def create_upper_cabinet(name, position, width):
    ...
    # Door knobs (small black round knobs for upper cabinets) - now on the outside
    knob_radius = 0.012
    knob_depth = 0.02
