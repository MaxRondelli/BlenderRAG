...
wood_color = (0.22, 0.15, 0.10, 1)  # Darker espresso brown
wood_metallic = 0.15
wood_roughness = 0.25

door_color = (0.25, 0.18, 0.12, 1)  # Slightly lighter espresso for doors
door_metallic = 0.15
door_roughness = 0.2

handle_color = (0.85, 0.7, 0.45, 1)  # Brass finish
handle_metallic = 0.9
handle_roughness = 0.25

shelf_color = (0.24, 0.17, 0.11, 1)
shelf_metallic = 0.1
...
# COUNTERTOP - Thicker and more luxurious
counter_height = lower_cabinet_height
counter_thickness = 0.06  # Thicker countertop
countertop_color = (0.18, 0.18, 0.20, 1)  # Darker granite-like
countertop_metallic = 0.6
countertop_roughness = 0.12
...
def create_lower_cabinet(name, position, width):
    ...
    # Door handles - now on the outside, brass finish
    handle_height = 0.018  # Slightly thicker handles
    handle_width = 0.14  # Slightly longer handles
    handle_depth = 0.03
...
def create_upper_cabinet(name, position, width):
    ...
    # Door knobs (small round knobs for upper cabinets) - now on the outside, brass finish
    knob_radius = 0.014  # Slightly larger brass knobs
    knob_depth = 0.025
