...
handle_color = (0.85, 0.65, 0.35, 1)  # Brass finish
...
countertop_color = (0.12, 0.12, 0.14, 1)  # Darker granite-like
...
def create_lower_cabinet(name, position, width):
    ...
    # Door handles - now brass finish and thicker
    handle_height = 0.018
    handle_width = 0.14
    handle_depth = 0.03
...
def create_upper_cabinet(name, position, width):
    ...
    left_glass = create_box(
        ...
        (0.85, 0.90, 0.95, 0.3),  # Translucent glass
        0.1, 0.05
    )
    ...
    # Door knobs (brass knobs for upper cabinets) - now brass and slightly larger
    knob_radius = 0.015
    knob_depth = 0.025
