...
# CABINET MATERIALS - Modern White Color Scheme
wood_color = (0.95, 0.95, 0.95, 1)  # Pure white
wood_metallic = 0.05
wood_roughness = 0.1  # Glossy finish

door_color = (0.98, 0.98, 0.98, 1)  # Slightly brighter white for doors
door_metallic = 0.05
door_roughness = 0.08  # Even glossier

handle_color = (0.85, 0.85, 0.85, 1)  # Stainless steel
handle_metallic = 0.95  # More metallic
handle_roughness = 0.15  # Smoother

shelf_color = (0.96, 0.96, 0.96, 1)
shelf_metallic = 0.05
shelf_roughness = 0.12
...
cabinet_thickness = 0.025  # Slightly thicker for modern look

# COUNTERTOP
counter_height = lower_cabinet_height
counter_thickness = 0.06  # Thicker countertop for modern appearance
countertop_color = (0.92, 0.92, 0.94, 1)  # Light grey quartz
countertop_metallic = 0.3
countertop_roughness = 0.08  # Glossy finish
...
def create_lower_cabinet(name, position, width):
    ...
    # Door handles - now on the outside (sleeker bar handles)
    handle_height = 0.012
    handle_width = 0.15  # Longer for modern look
    handle_depth = 0.02
