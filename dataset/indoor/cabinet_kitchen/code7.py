...
# CABINET MATERIALS - Updated to darker charcoal wood
wood_color = (0.22, 0.20, 0.18, 1)  # Dark charcoal wood
wood_metallic = 0.15
wood_roughness = 0.25

door_color = (0.25, 0.23, 0.20, 1)  # Slightly lighter charcoal for doors
door_metallic = 0.15
door_roughness = 0.2

handle_color = (0.85, 0.65, 0.35, 1)  # Brass colored hardware
handle_metallic = 0.9
handle_roughness = 0.2

shelf_color = (0.24, 0.22, 0.19, 1)
shelf_metallic = 0.1
shelf_roughness = 0.3
...
# COUNTERTOP - Updated to white marble style with increased thickness
counter_height = lower_cabinet_height
counter_thickness = 0.06  # Increased thickness for luxury look
countertop_color = (0.92, 0.90, 0.88, 1)  # White marble-like
countertop_metallic = 0.3
countertop_roughness = 0.1
...
def create_lower_cabinet(name, position, width):
    ...
    # Door handles - now on the outside with brass finish
    handle_height = 0.018
    handle_width = 0.15
    handle_depth = 0.03
...
def create_upper_cabinet(name, position, width):
    ...
    # Door knobs (small round knobs for upper cabinets) - now on the outside with brass finish
    knob_radius = 0.015
    knob_depth = 0.025
