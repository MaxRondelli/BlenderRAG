...
PLATE_DEPTH = 0.08 # Deeper well (8cm)
PLATE_THICKNESS = 0.004  # Slightly thicker ceramic (4mm)
RIM_WIDTH = 0.05  # Wider rim (5cm)
...
def create_realistic_plate():
    ...
    # Create burnt orange ceramic material
...
def create_ceramic_material(obj):
    """
    Creates a burnt orange ceramic material for the plate
    """
    # Create new material
    mat = bpy.data.materials.new(name="BurntOrangeCeramic")
    mat.use_nodes = True
    ...
    # Set ceramic properties with burnt orange color
    principled_node.inputs['Base Color'].default_value = (0.85, 0.35, 0.1, 1.0)  # Burnt orange color
    
    # Ceramic properties with more matte finish
