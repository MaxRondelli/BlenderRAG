...
# Modified plate dimensions for shallow decorative style
PLATE_DIAMETER = 0.32  # Slightly larger 32cm diameter
PLATE_RADIUS = PLATE_DIAMETER / 2
PLATE_DEPTH = 0.025 # Reduced depth for shallow design (2.5cm)
PLATE_THICKNESS = 0.004  # Slightly thicker ceramic (4mm)
RIM_WIDTH = 0.045  # Wider decorative rim (4.5cm)
...
def create_ceramic_material(obj):
    ...
    principled_node.inputs['Base Color'].default_value = (0.12, 0.25, 0.65, 1.0)  # Deep blue color
    
    # Enhanced ceramic properties for glossier finish
    principled_node.inputs['Metallic'].default_value = 0.0
    principled_node.inputs['Roughness'].default_value = 0.08  # Much more glossy
