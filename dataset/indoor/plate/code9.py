...
PLATE_THICKNESS = 0.005  # Thicker ceramic (5mm)
...
def create_ceramic_material(obj):
    """
    Creates a black ceramic material for the plate
    """
    # Create new material
    mat = bpy.data.materials.new(name="BlackCeramic")
    mat.use_nodes = True
    ...
    # Set ceramic properties with black color
    principled_node.inputs['Base Color'].default_value = (0.08, 0.08, 0.08, 1.0)  # Dark black color
    
    # Ceramic properties
    principled_node.inputs['Metallic'].default_value = 0.0
    principled_node.inputs['Roughness'].default_value = 0.1  # More glossy finish
