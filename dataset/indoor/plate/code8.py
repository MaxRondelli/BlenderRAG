...
# Rustic plate dimensions (in meters)
# Traditional handmade plate: slightly larger and deeper
PLATE_DIAMETER = 0.32  # 32cm diameter
PLATE_RADIUS = PLATE_DIAMETER / 2
PLATE_DEPTH = 0.08  # Deeper well for rustic style (8cm)
PLATE_THICKNESS = 0.005  # Slightly thicker for handmade feel (5mm)
RIM_WIDTH = 0.04  # Wider rim (4cm)
...
def create_realistic_plate():
    ...
    # Create brown rustic ceramic material
...
def create_ceramic_material(obj):
    """
    Creates a brown rustic ceramic material for the plate
    """
    # Create new material
    mat = bpy.data.materials.new(name="BrownCeramic")
    mat.use_nodes = True
    ...
    # Set ceramic properties with earthy brown color
    principled_node.inputs['Base Color'].default_value = (0.45, 0.25, 0.12, 1.0)  # Rich brown color
    
    # Ceramic properties
    principled_node.inputs['Metallic'].default_value = 0.0
    principled_node.inputs['Roughness'].default_value = 0.6  # More matte for rustic feel
