...
# Modern plate dimensions (in meters)
# Contemporary dinner plate: 28cm diameter
PLATE_DIAMETER = 0.28  # 28cm diameter
...
def create_realistic_plate():
    ...
    # Create charcoal gray ceramic material
...
def create_ceramic_material(obj):
    """
    Creates a charcoal gray ceramic material for the plate
    """
    # Create new material
    mat = bpy.data.materials.new(name="CharcoalCeramic")
    mat.use_nodes = True
    ...
    # Set ceramic properties with charcoal gray color
    principled_node.inputs['Base Color'].default_value = (0.15, 0.15, 0.18, 1.0)  # Charcoal gray color
    
    # Modern ceramic properties with higher gloss
    principled_node.inputs['Metallic'].default_value = 0.0
    principled_node.inputs['Roughness'].default_value = 0.05  # High gloss finish
