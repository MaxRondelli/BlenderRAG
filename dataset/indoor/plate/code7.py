...
PLATE_THICKNESS = 0.006  # Thicker ceramic (6mm)
RIM_WIDTH = 0.035  # Width of the rim (3.5cm)
...
def create_realistic_plate():
    ...
    profile_points = [
        ...
        (PLATE_RADIUS * 0.7, -PLATE_DEPTH * 0.6),      # More gradual curve up
...
def create_ceramic_material(obj):
    ...
    principled_node.inputs['Base Color'].default_value = (0.15, 0.25, 0.85, 1.0)  # Deep blue color
    
    # Ceramic properties
    principled_node.inputs['Metallic'].default_value = 0.0
    principled_node.inputs['Roughness'].default_value = 0.35  # More matte finish
