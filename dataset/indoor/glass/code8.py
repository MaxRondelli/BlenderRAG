...
# Champagne flute dimensions - modified for variation
bowl_bottom_radius = 0.015  # Slightly wider at bottom (was 0.012)
bowl_top_radius = 0.028     # Slightly wider at rim (was 0.025)
bowl_height = 0.14          # Same bowl height
stem_radius = 0.003         # Slightly thicker stem (was 0.0025)
stem_height = 0.12          # Same stem height
base_radius = 0.032         # Same base radius
base_thickness = 0.003      # Same base thickness
glass_thickness = 0.002     # Thicker glass walls for luxury feel (was 0.0012)
...
glass_bsdf.inputs['Roughness'].default_value = 0.01  # Slightly rougher for luxury feel
...
print("\nVariation changes:")
print("  ✓ Amber-tinted glass (warm golden color)")
print("  ✓ Thicker glass walls for luxury feel")
print("  ✓ Slightly wider bowl dimensions")
print("  ✓ Thicker stem for enhanced stability")