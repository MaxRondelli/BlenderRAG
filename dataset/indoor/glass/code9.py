...
# Champagne flute dimensions - slightly thicker walls
...
glass_thickness = 0.0018    # 1.8mm glass wall thickness (thicker for luxury feel)
...
glass_bsdf.inputs['Color'].default_value = (1.0, 0.75, 0.3, 1.0)  # Rich amber color
...
print("\nVariation features:")
print("  ✓ Rich amber/golden glass coloring")
print("  ✓ Slightly thicker glass walls (1.8mm)")
print("  ✓ Higher IOR for more luxurious refraction")