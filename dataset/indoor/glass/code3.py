...
# Wine glass dimensions (wider bowl variation)
bowl_bottom_radius = 0.018      # 1.8cm at bottom of bowl (wider than champagne flute)
bowl_top_radius = 0.035         # 3.5cm at rim (wider)
bowl_height = 0.12              # 12cm bowl height (slightly shorter)
stem_radius = 0.003             # 3mm stem thickness (slightly thicker)
stem_height = 0.10              # 10cm stem height
base_radius = 0.035             # 3.5cm base radius (wider)
...
# STEP 5: Mark stem edges as sharp BEFORE joining
...
glass_bsdf.inputs['Roughness'].default_value = 0.001
glass_bsdf.inputs['Color'].default_value = (1.0, 0.7, 0.3, 1.0)  # Amber color

# Add ColorRamp for enhanced color variation
color_ramp = nodes.new(type='ShaderNodeValToRGB')
color_ramp.location = (-200, 0)
color_ramp.color_ramp.elements[0].color = (0.9, 0.6, 0.2, 1.0)  # Deep amber
color_ramp.color_ramp.elements[1].color = (1.0, 0.8, 0.4, 1.0)  # Light amber

# Fresnel node for realistic glass reflection
...
if wine_glass.data.materials:
    wine_glass.data.materials[0] = mat
else:
    wine_glass.data.materials.append(mat)
...
# Add rim lighting
bpy.ops.object.light_add(type='SPOT', location=(0.2, 0.2, 0.25))
...
print("Amber wine glass generated successfully!")
print(f"Dimensions:")
...
print("\nVariations applied:")
print("  ✓ Amber-tinted glass material with enhanced reflections")
print("  ✓ Wider bowl proportions for wine glass style")
print("  ✓ Thicker stem and base for sturdier appearance")