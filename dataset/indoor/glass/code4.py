...
# Wine glass dimensions (wider bowl than champagne flute)
...
base_thickness = 0.004      # 4mm base thickness
...
# STEP 6: Create red-tinted glass material
mat = bpy.data.materials.new(name="Red_Wine_Glass_Material")
mat.use_nodes = True
...
glass_bsdf.inputs['Color'].default_value = (1.0, 0.75, 0.65, 1.0)  # Warm amber-red tint
...
# STEP 7: Setup camera
bpy.ops.object.camera_add(location=(0.28, -0.28, 0.18))
...
bpy.ops.object.light_add(type='AREA', location=(0, -0.35, 0.35))
...
print("Red wine glass generated successfully!")
print(f"Dimensions:")
