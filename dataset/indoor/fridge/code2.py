...
def create_fridge_body(location=(0, 0, 0), size=(1.1, 0.85, 1.8)):
    ...
    body_mat = create_material("FridgeMaterial", (0.15, 0.15, 0.18), metallic=0.9, roughness=0.15)
...
def create_fridge_door(location, size, name="Door"):
    ...
    door_mat = create_material(f"{name}_Material", (0.12, 0.12, 0.16), metallic=0.95, roughness=0.1)
...
def create_door_handle(location, size, orientation='vertical'):
    ...
    handle_mat = create_material("HandleMaterial", (0.3, 0.3, 0.35), metallic=0.95, roughness=0.1)
...
def create_dispenser_panel(location):
    ...
    dispenser_mat = create_material("DispenserMaterial", (0.05, 0.05, 0.08), metallic=0.0, roughness=0.4)
