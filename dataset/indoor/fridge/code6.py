...
def create_fridge_body(location=(0, 0, 0), size=(0.9, 0.8, 1.8)):
    ...
    body_mat = create_material("FridgeMaterial", (0.25, 0.25, 0.28), metallic=0.85, roughness=0.2)
...
def create_fridge_door(location, size, name="Door"):
    ...
    # Create material for door (dark metallic)
    door_mat = create_material(f"{name}_Material", (0.2, 0.2, 0.23), metallic=0.9, roughness=0.15)
...
def create_door_handle(location, size, orientation='vertical'):
    ...
    # Create brushed steel material for handle
    handle_mat = create_material("HandleMaterial", (0.4, 0.4, 0.42), metallic=0.95, roughness=0.1)
...
def create_dispenser_panel(location):
    ...
    dispenser_mat = create_material("DispenserMaterial", (0.08, 0.08, 0.09), metallic=0.0, roughness=0.7)
