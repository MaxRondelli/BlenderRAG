...
def create_walnut_material():
    """Create a rich walnut wood material for the tabletop and shelf"""
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.35, 0.22, 0.12, 1.0)  # Rich walnut color
...
def create_copper_material():
    ...
    node_bsdf.inputs['Roughness'].default_value = 0.6  # Brushed finish
...
# Create materials
wood_mat = create_walnut_material()
...
print("Walnut and copper coffee table created successfully!")
