...
# Table dimensions (in meters) - slightly thicker components
table_length = 1.2
table_width = 0.6
table_height = 0.4
...
def create_metal_material():
    """Create a brass-colored metal material for the frame"""
...
sun.data.energy = 2.5  # Slightly brighter to show brass better
