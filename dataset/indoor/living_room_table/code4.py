...
table_width = 0.6
table_height = 0.4
top_thickness = 0.045  # Increased from 0.03
shelf_height = 0.15
...
def create_mahogany_material():
    """Create a rich mahogany wood material for the tabletop and shelf"""
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.4, 0.15, 0.1, 1.0)  # Rich mahogany color
...
# Join all frame pieces into one object
