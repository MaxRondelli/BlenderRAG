...
def create_wood_material():
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.3, 0.2, 0.12, 1.0)  # Dark walnut color
...
def create_metal_material():
    """Create a dark gunmetal material for the frame"""
    ...
    node_bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    node_bsdf.location = (0, 0)
    node_bsdf.inputs['Base Color'].default_value = (0.15, 0.15, 0.18, 1.0)  # Dark gunmetal gray
...
if len(bpy.context.selected_objects) > 0:
    bpy.ops.object.join()
    bpy.context.active_object.name = "Metal_Frame"
...
print("Dark industrial coffee table created successfully!")
