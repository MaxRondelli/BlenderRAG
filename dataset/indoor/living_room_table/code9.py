...
# Table dimensions (in meters) - slightly modified
table_length = 1.2
table_width = 0.6
table_height = 0.4
top_thickness = 0.04  # Increased thickness
shelf_height = 0.15
shelf_thickness = 0.035  # Slightly thicker shelf
frame_width = 0.035  # Slightly thicker frame

# Materials
def create_wood_material():
    """Create a dark walnut wood material for the tabletop and shelf"""
    mat = bpy.data.materials.new(name="DarkWalnut")
    mat.use_nodes = True
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.25, 0.15, 0.08, 1.0)  # Dark walnut color
...
# Set up camera
bpy.ops.object.camera_add(location=(2.5, -2.5, 1.8), rotation=(math.radians(60), 0, math.radians(50)))
...
# Add a warmer fill light
bpy.ops.object.light_add(type='AREA', location=(-3, 3, 5))
area_light = bpy.context.active_object
area_light.data.energy = 150
area_light.data.size = 6
area_light.data.color = (1.0, 0.9, 0.8)
...
print("Dark walnut coffee table with copper frame created successfully!")
