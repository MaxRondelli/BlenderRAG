...
def create_walnut_material():
    """Create a walnut wood material for the tabletop and shelf"""
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.35, 0.2, 0.1, 1.0)  # Rich walnut color
...
def create_copper_material():
    ...
    node_bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    node_bsdf.location = (0, 0)
    node_bsdf.inputs['Base Color'].default_value = (0.8, 0.5, 0.3, 1.0)  # Copper color
...
# Create materials
walnut_mat = create_walnut_material()
...
tabletop.data.materials.append(walnut_mat)
...
shelf.data.materials.append(walnut_mat)
