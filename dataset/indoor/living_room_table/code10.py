...
def create_wood_material():
    ...
    mat = bpy.data.materials.new(name="MahoganyWood")
    mat.use_nodes = True
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.4, 0.2, 0.1, 1.0)  # Rich mahogany color
...
def create_brass_material():
    ...
    node_bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    node_bsdf.location = (0, 0)
    node_bsdf.inputs['Base Color'].default_value = (0.8, 0.6, 0.2, 1.0)  # Warm brass color
...
# Create brass frame legs (4 vertical legs)
leg_positions = [
...
for i, (x, y) in enumerate(leg_positions):
    ...
    leg.data.materials.append(brass_mat)
    legs.append(leg)
...
for y_pos in [table_width/2 - frame_width/2, -(table_width/2 - frame_width/2)]:
    ...
    frame_long.data.materials.append(brass_mat)
...
for x_pos in [table_length/2 - frame_width/2, -(table_length/2 - frame_width/2)]:
    ...
    frame_short.data.materials.append(brass_mat)
...
print("Mahogany and brass coffee table created successfully!")
