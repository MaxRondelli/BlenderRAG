...
def create_bookshelf(location, num_shelves=5):
    ...
    for i in range(num_shelves + 1):
        ...
        bpy.ops.mesh.primitive_cube_add(
            ...
            scale=(shelf_width/2, shelf_depth/2, 0.045)
        )
        ...
        if i < num_shelves:
            ...
            for j in range(num_books):
                ...
                book_colors = [
                    (0.45, 0.3, 0.2), (0.35, 0.4, 0.45), (0.4, 0.45, 0.3),
                    (0.5, 0.35, 0.4), (0.55, 0.45, 0.25), (0.4, 0.25, 0.15),
                    (0.3, 0.4, 0.35), (0.5, 0.4, 0.3)
                ]
                ...
                book_z = shelf_z + 0.045 + book_height
...
def main():
    ...
    # Position camera to view the bookshelf
