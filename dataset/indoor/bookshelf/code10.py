...
def create_bookshelf(location, num_shelves=5):
    ...
    # Create vertical sides with increased thickness
    ...
    # Create back panel with increased thickness
    bpy.ops.mesh.primitive_cube_add(
    ...
    for i in range(num_shelves + 1):
        ...
        if i < num_shelves:
            ...
            for j in range(num_books):
                book_colors = [
                    (0.6, 0.35, 0.2), (0.4, 0.25, 0.15), (0.5, 0.4, 0.25),
                    (0.45, 0.3, 0.18), (0.7, 0.5, 0.3), (0.35, 0.2, 0.12),
                    (0.55, 0.4, 0.28), (0.65, 0.45, 0.25), (0.3, 0.18, 0.1)
                ]
                
                book_x = location[0] - shelf_width/2 + 0.25 + (j * (shelf_width - 0.5) / num_books)
                
                book_height = random.uniform(0.08, 0.28)
                book_thickness = random.uniform(0.02, 0.05)
