...
def create_couch_materials():
    ...
    # Main leather material - chocolate brown
    ...
    # Add color ramp for noise
    ramp = nodes.new(type='ShaderNodeValToRGB')
    ramp.location = (0, 200)
    ramp.color_ramp.elements[0].position = 0.4
    ramp.color_ramp.elements[1].position = 0.6
    
    # Mix node for combining base color with noise
    mix = nodes.new(type='ShaderNodeMix')
    mix.location = (200, 0)
    mix.data_type = 'RGBA'
    mix.blend_type = 'MULTIPLY'
    mix.inputs[0].default_value = 0.2  # Mix factor
    
    # Rich chocolate brown leather color
    bsdf.inputs['Base Color'].default_value = (0.18, 0.12, 0.08, 1.0)
    bsdf.inputs['Roughness'].default_value = 0.4  # Leather finish
    bsdf.inputs['Metallic'].default_value = 0.0
    bsdf.inputs['IOR'].default_value = 1.45  # Leather IOR
    ...
    main_leather.node_tree.links.new(bsdf.outputs['BSDF'], output.inputs['Surface'])
    ...
    # Lighter chocolate brown for cushions
    principled.inputs['Base Color'].default_value = (0.22, 0.15, 0.11, 1.0)
