...
def create_armrest(width, depth, height, location, name):
    ...
    bmesh.ops.bevel(bm, geom=edges_to_bevel, offset=0.09, segments=4, 
...
def create_couch_materials():
    ...
    # Add ColorRamp for better control
    ...
    ramp.color_ramp.elements[0].color = (0.15, 0.10, 0.07, 1.0)
    ramp.color_ramp.elements[1].position = 0.8
    ramp.color_ramp.elements[1].color = (0.28, 0.21, 0.15, 1.0)
    
    # Slightly lighter brown for cushions
    principled.inputs['Base Color'].default_value = (0.22, 0.16, 0.11, 1.0)
