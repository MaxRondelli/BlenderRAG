...
def create_couch_section(width, depth, base_height, back_height, location, section_name, num_cushions=3):
    ...
    armrest_height = 0.65
    seat_height = 0.18  # Slightly increased thickness
    back_cushion_thickness = 0.22  # Slightly increased thickness
...
def create_couch_materials():
    ...
    # Add color ramp for leather texture variation
    ramp = nodes.new(type='ShaderNodeValToRGB')
    ramp.location = (-100, 200)
    ramp.color_ramp.elements[0].color = (0.15, 0.08, 0.04, 1.0)  # Dark brown
    ramp.color_ramp.elements[1].color = (0.22, 0.14, 0.08, 1.0)  # Lighter brown
    
    # Mix node to blend colors
    ...
    bsdf.inputs['Roughness'].default_value = 0.3  # Lower roughness for leather
