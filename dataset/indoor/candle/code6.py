...
# Set up candle material (burgundy color with gold accent)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.4, 0.1, 0.15, 1.0)  # Deep burgundy color
bsdf.inputs['Metallic'].default_value = 0.2  # Slight metallic sheen
...
emission.inputs['Color'].default_value = (1.0, 0.3, 0.05, 1.0)  # Deep orange-red flame
# emission.inputs['Emission Strength'].default_value = 25.0
...
flame_light.data.color = (1.0, 0.5, 0.15)
...
ground_bsdf.inputs['Base Color'].default_value = (0.15, 0.10, 0.08, 1.0)
...
bg_node.inputs['Color'].default_value = (0.05, 0.03, 0.06, 1.0)
