...
# Set up candle material (burgundy red color)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.6, 0.15, 0.2, 1.0)  # Deep burgundy red
...
emission.inputs['Color'].default_value = (1.0, 0.3, 0.05, 1.0)  # Deeper red-orange flame
...
flame_light.data.color = (1.0, 0.5, 0.2)  # Warmer, more reddish light
...
ground_bsdf.inputs['Base Color'].default_value = (0.15, 0.1, 0.1, 1.0)  # Slightly reddish ground
...
bg_node.inputs['Color'].default_value = (0.08, 0.05, 0.05, 1.0)  # Warmer dark background
...
key_light.data.color = (1.0, 0.7, 0.5)  # Warmer key light
