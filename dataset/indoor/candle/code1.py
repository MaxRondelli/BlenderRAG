...
# Set up candle material (bright pink color)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.95, 0.4, 0.65, 1.0)  # Bright pink color
...
wick_bsdf.inputs['Base Color'].default_value = (0.1, 0.05, 0.02, 1.0)
wick_bsdf.inputs['Roughness'].default_value = 0.9
...
emission.inputs['Color'].default_value = (1.0, 0.2, 0.6, 1.0)  # Magenta-pink flame
bsdf = flame_nodes.new(type='ShaderNodeBsdfPrincipled')
bsdf.inputs['Base Color'].default_value = (1.0, 0.2, 0.6, 1.0)
bsdf.inputs['Emission Strength'].default_value = 25.0

flame_links.new(bsdf.outputs['BSDF'], output.inputs['Surface'])
...
flame_light.data.color = (1.0, 0.8, 0.4)
...
ground_bsdf.inputs['Base Color'].default_value = (0.3, 0.25, 0.3, 1.0)
ground_bsdf.inputs['Roughness'].default_value = 0.5

# Set up world background (warmer for festive feel)
bpy.context.scene.world.use_nodes = True
world_nodes = bpy.context.scene.world.node_tree.nodes
bg_node = world_nodes['Background']
bg_node.inputs['Color'].default_value = (0.08, 0.06, 0.12, 1.0)
