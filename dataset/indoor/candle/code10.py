...
# Set up candle material (bright purple color)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.8, 0.3, 0.9, 1.0)  # Vibrant purple color
...
emission.inputs['Color'].default_value = (1.0, 0.9, 0.2, 1.0)  # Bright yellow flame
...
flame_light.data.color = (1.0, 0.9, 0.4)
...
# Set up world background (slightly warmer for festive feel)
