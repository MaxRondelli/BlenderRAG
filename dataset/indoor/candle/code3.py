...
# Set up candle material (burgundy/deep red color)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.7, 0.2, 0.3, 1.0)  # Deep burgundy color
...
emission.inputs['Color'].default_value = (1.0, 0.3, 0.1, 1.0)  # Deeper red-orange flame
bsdf.inputs['Emission Strength'].default_value = 25.0

flame_links.new(emission.outputs[0], output.inputs['Surface'])
...
flame_light.data.color = (1.0, 0.6, 0.2)
...
ground_bsdf.inputs['Base Color'].default_value = (0.15, 0.1, 0.1, 1.0)  # Darker reddish ground
...
bg_node.inputs['Color'].default_value = (0.08, 0.05, 0.05, 1.0)
...
key_light.data.color = (1.0, 0.8, 0.5)  # Warmer golden light
