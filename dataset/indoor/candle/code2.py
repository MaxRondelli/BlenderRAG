...
# Set up candle material (deep red wax color)
bsdf = candle_mat.node_tree.nodes["Principled BSDF"]
bsdf.inputs['Base Color'].default_value = (0.7, 0.15, 0.12, 1.0)  # Deep red color
...
wick_bsdf.inputs['Base Color'].default_value = (0.1, 0.08, 0.02, 1.0)
...
emission.inputs['Color'].default_value = (1.0, 0.35, 0.05, 1.0)  # Deeper orange-red flame
...
flame_light.data.color = (1.0, 0.5, 0.2)
...
ground_bsdf.inputs['Base Color'].default_value = (0.15, 0.1, 0.08, 1.0)
...
bg_node.inputs['Color'].default_value = (0.08, 0.04, 0.06, 1.0)
