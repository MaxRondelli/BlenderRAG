...
bsdf.inputs['Base Color'].default_value = (0.95, 0.3, 0.6, 1.0)  # Bright pink color
...
# Set up world background (warmer dark tone)
bpy.context.scene.world.use_nodes = True
world_nodes = bpy.context.scene.world.node_tree.nodes
bg_node = world_nodes['Background']
bg_node.inputs['Color'].default_value = (0.08, 0.06, 0.05, 1.0)
