...
def create_wooden_door():
    ...
    panel_depth = 0.015  # How deep panels are recessed into door
...
def create_wood_material():
    """Create a weathered wood material with darker, more rustic appearance"""
    ...
    # Weathered wood color (darker, grayer brown tone)
    node_bsdf.inputs['Base Color'].default_value = (0.22, 0.15, 0.10, 1.0)
    node_bsdf.inputs['Roughness'].default_value = 0.75
    node_bsdf.inputs['IOR'].default_value = 1.2
    ...
    node_color_ramp.color_ramp.elements[0].color = (0.15, 0.10, 0.07, 1)
    node_color_ramp.color_ramp.elements[1].color = (0.28, 0.19, 0.13, 1)
    
    node_noise = nodes.new(type='ShaderNodeTexNoise')
    node_noise.location = (-400, -100)
    node_noise.inputs['Scale'].default_value = 65.0
    node_noise.inputs['Detail'].default_value = 20.0
