...
def create_painted_wood_material(name, base_color, roughness=0.8):
    """Create a painted wood material with weathered appearance"""
    ...
    # Noise texture for weathered paint effect
...
def create_painted_window():
    """Create a painted wooden window with weathered white finish"""
    
    # ============ DIMENSIONS (in meters) ============
    TOTAL_WIDTH = 1.2        # Total outer width
    TOTAL_HEIGHT = 1.2       # Total outer height
    FRAME_DEPTH = 0.08       # Depth (Z direction)
    FRAME_THICKNESS = 0.12   # Thicker frame for rustic look
    MUNTIN_THICKNESS = 0.06  # Thicker muntins
    ...
    # Create painted wood material (weathered white)
    wood_mat = create_painted_wood_material(
        "PaintedWoodMaterial",
    ...
    glass_node.inputs['Color'].default_value = (0.8, 0.85, 0.95, 1.0)  # Blue tint
    ...
    for obj in all_wood_objects:
        ...
        # Bevel for rounded edges (more pronounced for rustic look)
    ...
    print("\n" + "="*60)
    print("PAINTED WINDOW CREATED SUCCESSFULLY!")
    print("="*60)
    ...
    print(f"Glass Panes: 4 (2×2 grid) - Blue tinted")
    print("Material: Weathered white painted wood")
    print("="*60 + "\n")
    
    return window

# Create the window
window = create_painted_window()
