...
def create_wood_material(name, base_color, roughness=0.6):
    ...
    principled.inputs['IOR'].default_value = 0.3
...
def create_wooden_window():
    ...
    FRAME_THICKNESS = 0.14   # Thicker for Victorian style
    ...
    # Create dark mahogany wood material
    wood_mat = create_wood_material(
        "MahoganyMaterial",
        base_color=(0.12, 0.06, 0.03, 1.0),  # Darker mahogany color
        roughness=0.4  # Slightly more polished
    )
    ...
    glass_mat = bpy.data.materials.new(name="BlueGlass")
    ...
    for obj in all_wood_objects:
        ...
        # Larger bevel for more ornate Victorian look
    ...
    print("\n" + "="*60)
    print("VICTORIAN WOODEN WINDOW CREATED SUCCESSFULLY!")
    print("="*60)
