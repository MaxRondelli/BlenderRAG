...
def create_wooden_window():
    ...
    FRAME_THICKNESS = 0.12   # Thicker outer frame for rustic look
    MUNTIN_THICKNESS = 0.06  # Thicker center dividers
    ...
    # Create darker wood material
    wood_mat = create_wood_material(
        "DarkWoodMaterial",
        base_color=(0.12, 0.08, 0.04, 1.0),  # Darker brown
    ...
    glass_node.inputs['Color'].default_value = (0.85, 0.9, 0.85, 1.0)  # Slight green tint
    ...
    for obj in all_wood_objects:
        ...
        bevel.width = 0.004  # Slightly larger bevel for rustic look
        bevel.segments = 2
