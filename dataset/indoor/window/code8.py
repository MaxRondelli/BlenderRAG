...
def create_wooden_window():
    ...
    FRAME_THICKNESS = 0.14   # Increased thickness for more substantial look
    MUNTIN_THICKNESS = 0.06  # Slightly thicker muntins
    GLASS_THICKNESS = 0.004  # Glass thickness
    GLASS_RECESS = 0.03      # Deeper glass recess for more depth
    ...
    wood_mat = create_wood_material(
        "OakMaterial",
        base_color=(0.15, 0.08, 0.04, 1.0),  # Darker brown oak color
        roughness=0.7  # Slightly rougher surface
    )
    ...
    glass_node.inputs['Color'].default_value = (0.92, 0.96, 1.0, 1.0)  # Slightly warmer glass tint
    ...
    for obj in all_wood_objects:
        ...
        bevel.width = 0.005  # Slightly larger bevel for rustic look
        bevel.segments = 2
    ...
    print("\n" + "="*60)
    print("RUSTIC OAK WINDOW CREATED SUCCESSFULLY!")
    print("="*60)
