...
def create_wooden_window():
    ...
    FRAME_THICKNESS = 0.14   # Thickness of outer frame (increased)
    MUNTIN_THICKNESS = 0.06  # Thickness of center dividers (increased)
    ...
    # Create wood material with darker oak finish
    wood_mat = create_wood_material(
        "WoodMaterial",
        base_color=(0.12, 0.08, 0.04, 1.0),  # Darker oak color
        roughness=0.7  # More weathered appearance
    )
    ...
    glass_node.inputs['Color'].default_value = (0.85, 0.9, 0.8, 1.0)  # Slightly tinted green glass
    ...
    for obj in all_wood_objects:
        ...
        bevel.width = 0.005  # Slightly larger bevel for more weathered look
        bevel.segments = 2
    ...
    print("\n" + "="*60)
    print("WOODEN WINDOW CREATED SUCCESSFULLY!")
    print("="*60)
