...
def create_brass_base():
    ...
    mat_base = bpy.data.materials.new(name="Brass_Metal")
    ...
    # Rich brass color - golden bronze
...
# Create the amber glass base bulb
def create_amber_bulb():
    ...
    node_bsdf.inputs['Base Color'].default_value = (1.0, 0.6, 0.15, 1.0)
    ...
    node_mix.inputs['Fac'].default_value = 0.4  # Mix factor
...
# Create the brass neck/stem
def create_brass_neck():
    ...
    # Use brass material
    mat_brass = bpy.data.materials.get("Brass_Metal")
    if mat_brass:
...
def create_amber_shade():
    ...
    mat_amber = bpy.data.materials.get("Amber_Glass")
    if mat_amber:
...
def create_lighting():
    ...
    # Rim light to highlight brass and glass edges
...
print("Creating brass and amber lamp...")

# Create all components
base = create_brass_base()
bulb = create_amber_bulb()
neck = create_brass_neck()
shade = create_amber_shade()
...
print("Brass and amber lamp created!")
print("- Brass base and neck: Golden bronze metallic finish")
print("- Amber glass shade and bulb: Warm amber tint with enhanced glow")