...
def create_brass_base():
    ...
    # Create polished brass material
    mat_base = bpy.data.materials.new(name="Polished_Brass")
...
# Create the lampshade with thicker walls
def create_lampshade():
    ...
    # Add solidify modifier for thicker walls
...
print("Creating brass lamp with amber glass...")
...
print("Brass lamp created with amber glass!")