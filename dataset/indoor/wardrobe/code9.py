...
# Panel thickness - increased for more robust appearance
PANEL_THICKNESS = 0.035  # 3.5cm (increased from 2.5cm)
...
# Handle dimensions - increased for better ergonomics
HANDLE_WIDTH = 0.12  # 12cm (increased from 10cm)
HANDLE_HEIGHT = 0.020  # 2cm (increased from 1.5cm)
HANDLE_DEPTH = 0.030  # 3cm protrusion (increased from 2.5cm)

# Door handle dimensions (vertical) - also increased
DOOR_HANDLE_WIDTH = 0.020  # 2cm wide (increased from 1.5cm)
DOOR_HANDLE_HEIGHT = 0.18  # 18cm tall (increased from 15cm)
DOOR_HANDLE_DEPTH = 0.030  # 3cm protrusion (increased from 2.5cm)
...
def create_doors(divider_z):
    ...
    door_thickness = 0.025  # 2.5cm thick doors (increased from 2cm)
...
def create_drawers():
    ...
    drawer_depth = 0.025  # 2.5cm thick drawer fronts (increased from 2cm)
...
def apply_materials(components):
    ...
    ebony_color = (0.15, 0.12, 0.08, 1.0)  # Very dark brown for ebony
