...
def create_silver_material(name):
...
# Create Materials
# -------------------------
black_mat = create_black_material("BlackMetal")
silver_mat = create_silver_material("SilverMetal")

# -------------------------
# Base (on ground) - slightly larger
# -------------------------
base = make_cube("Base", (0.15, 0.15, 0.025), (0, 0, 0.0125))
base.data.materials.append(black_mat)
...
lower_arm_angle = 1.0  # slightly less angle
...
lower_arm = make_cube("LowerArm", (0.018, lower_arm_length, 0.018), 
                      ...
                      (lower_arm_angle, 0, 0))
lower_arm.data.materials.append(black_mat)

# -------------------------
# Joint (at end of lower arm) - silver
# -------------------------
...
upper_arm_angle = 0.3  # slightly different angle
...
upper_arm = make_cube("UpperArm", (0.018, upper_arm_length, 0.018), 
                      ...
                      (upper_arm_angle, 0, 0))
upper_arm.data.materials.append(black_mat)
...
head.data.materials.append(silver_mat)
...
print("✅ Modern black and silver desk lamp created successfully!")
