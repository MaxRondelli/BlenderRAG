...
def create_base_material():
    """Create dark gray base material"""
...
def create_bronze_material():
    """Create bronze metallic material for arms"""
    mat = bpy.data.materials.new(name="BronzeMaterial")
    mat.use_nodes = True
    bsdf = mat.node_tree.nodes["Principled BSDF"]
...
def create_blue_material():
    """Create bright blue material for lamp head"""
...
def create_joint_material():
    """Create chrome material for joints"""
...
blue_mat = create_blue_material()
chrome_mat = create_joint_material()
...
stem.data.materials.append(chrome_mat)
...
joint.data.materials.append(chrome_mat)
...
# -------------------------
bpy.ops.object.camera_add(location=(0.9, -0.7, 0.7))
...
print("✅ Colorful desk lamp created successfully with bronze arms and blue head!")
