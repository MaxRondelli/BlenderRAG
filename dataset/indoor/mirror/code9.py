...
def create_metal_frame_material():
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.1, 0.1, 0.12, 1.0)  # Dark metal
...
def create_mirror_material():
    """Create a highly reflective mirror material"""
    ...
    node_bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    node_bsdf.location = (0, 0)
    node_bsdf.inputs['Base Color'].default_value = (0.98, 0.98, 0.98, 1.0)
...
def create_base_material():
    """Create material for the walnut base"""
