...
# Mirror dimensions (in meters) - increased frame thickness
mirror_width = 0.5
mirror_height = 1.4
mirror_thickness = 0.01
frame_width = 0.08  # Increased from 0.05
frame_depth = 0.05  # Increased from 0.03
base_width = 0.6
base_depth = 0.4
base_height = 0.05
stand_width = 0.04
...
def create_wood_frame_material():
    """Create a warmer wooden frame material with bronze accents"""
    mat = bpy.data.materials.new(name="WoodFrame")
    mat.use_nodes = True
    ...
    node_bsdf.inputs['Base Color'].default_value = (0.45, 0.32, 0.2, 1.0)  # Warmer, richer wood
    node_bsdf.inputs['Roughness'].default_value = 0.25  # Smoother finish
    node_bsdf.inputs['Metallic'].default_value = 0.15  # Slight metallic sheen
...
def create_base_material():
    """Create material for the base with bronze finish"""
    ...
    node_bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    node_bsdf.location = (0, 0)
    node_bsdf.inputs['Base Color'].default_value = (0.52, 0.37, 0.18, 1.0)  # Bronze tone
    node_bsdf.inputs['Roughness'].default_value = 0.3
    node_bsdf.inputs['Metallic'].default_value = 0.4  # More metallic
...
base.modifiers["Bevel"].width = 0.008  # Increased bevel
...
frame_top.data.materials.append(wood_frame_mat)
...
frame_bottom.data.materials.append(wood_frame_mat)
...
frame_left.data.materials.append(wood_frame_mat)
...
frame_right.data.materials.append(wood_frame_mat)
