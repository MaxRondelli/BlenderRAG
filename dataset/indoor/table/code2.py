...
def create_modern_glass_table():
    ...
    # Noise texture for metal surface
    ...
    # Metal properties - brushed steel
    ...
    for obj in all_parts[1:]:  # All legs
...
def setup_lighting_and_camera():
    ...
    light3.data.energy = 400
    light3.data.size = 3
    light3.rotation_euler = (math.radians(30), 0, 0)
...
def main():
    ...
    print("✓ Modern glass table created with separate objects")
    print("  - Glass table top with blue tint")
    print("  - Brushed metal legs")
