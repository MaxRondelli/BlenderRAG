...
def create_simple_realistic_table():
    ...
    # Dimensions (meters) - adjusted for farmhouse style
    table_width = 1.8
    table_depth = 0.9
    table_height = 0.5
    ...
    for obj in all_parts:
        ...
        bevel.width = 0.008  # Slightly larger bevel for rustic look
        bevel.segments = 3
    ...
    bsdf.inputs['Roughness'].default_value = 0.5  # More rough for rustic feel
    ...
    mapping.inputs['Scale'].default_value = (8, 8, 8)  # Slightly different scale
    
    # Noise texture for more varied wood grain
    ...
    # Color ramp for darker mahogany tones
    ramp = nodes.new('ShaderNodeValToRGB')
    ramp.location = (-200, 0)
    ramp.color_ramp.elements[0].color = (0.2, 0.08, 0.04, 1.0)  # Dark mahogany
    ramp.color_ramp.elements[1].color = (0.5, 0.22, 0.12, 1.0)  # Lighter mahogany
    
    # Bump
    bump = nodes.new('ShaderNodeBump')
    bump.location = (-200, -200)
    bump.inputs['Strength'].default_value = 0.15  # More pronounced texture
