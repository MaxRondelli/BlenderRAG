...
# Create materials
# Deep burgundy leather color
fabric_material = create_material("Leather_Burgundy", (0.35, 0.15, 0.18, 1.0), roughness=0.3)
# Warm bronze/gold metal for legs
metal_material = create_material("Metal_Bronze", (0.65, 0.45, 0.25, 1.0), roughness=0.1, metallic=0.8)
...
left_armrest.scale = (0.32, 1.0, 0.75)
...
# ==================== LEGS ====================
# Create 4 angled metal legs - slightly thicker for luxury appearance
# Front left leg
bpy.ops.mesh.primitive_cylinder_add(radius=0.035, depth=0.5, location=(-0.55, 0.45, 0.25))
