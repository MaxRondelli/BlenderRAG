...
fabric_material = create_material("Leather_Burgundy", (0.4, 0.15, 0.15, 1.0), roughness=0.3)
# Darker gunmetal for legs
metal_material = create_material("Metal_Gunmetal", (0.2, 0.2, 0.25, 1.0), roughness=0.1, metallic=0.8)
...
# ==================== LEFT ARMREST ====================
# Create left armrest that flows from seat to backrest height - THICKER
...
left_armrest.scale = (0.35, 1.0, 0.8)
...
right_armrest.scale = (0.35, 1.0, 0.8)
