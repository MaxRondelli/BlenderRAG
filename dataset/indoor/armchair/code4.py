...
# Create materials
# Deep navy blue color for upholstery
fabric_material = create_material("Fabric_Navy", (0.15, 0.25, 0.45, 1.0), roughness=0.8)
# Rose gold metal for legs
metal_material = create_material("Metal_RoseGold", (0.75, 0.55, 0.45, 1.0), roughness=0.1, metallic=0.85)
...
# ==================== LEFT ARMREST ====================
# Create left armrest with more angular shape
...
left_armrest.scale = (0.28, 1.0, 0.62)

# Rotate to angle inward more sharply for angular look
left_armrest.rotation_euler = (math.radians(8), 0, math.radians(-8))
...
# ==================== RIGHT ARMREST ====================
# Mirror for right armrest with angular shape
bpy.ops.mesh.primitive_cube_add(size=1, location=(0.75, -0.15, 0.75))
right_armrest = bpy.context.active_object
right_armrest.name = "Right_Armrest"
right_armrest.scale = (0.28, 1.0, 0.62)

# Rotate to angle inward more sharply (mirrored)
right_armrest.rotation_euler = (math.radians(8), 0, math.radians(8))
