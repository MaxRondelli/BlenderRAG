...
# Create materials
# Rich burgundy leather color
leather_material = create_material("Leather_Burgundy", (0.45, 0.15, 0.15, 1.0), roughness=0.3)
# Golden brass for legs
metal_material = create_material("Metal_Gold", (0.85, 0.65, 0.25, 1.0), roughness=0.1, metallic=0.8)

# ==================== SEAT BASE ====================
# Create the main seat cushion - thicker and more plush
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, 0, 0.5))
seat = bpy.context.active_object
seat.name = "Seat_Cushion"
seat.scale = (1.8, 1.8, 0.6)
...
# ==================== BACKREST ====================
# Create curved backrest - thicker for more comfort
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, -0.65, 1.1))
backrest = bpy.context.active_object
backrest.name = "Backrest"
backrest.scale = (1.3, 0.25, 1.3)

# Rotate backrest to angle it back (connecting at the rear of seat)
backrest.rotation_euler = (math.radians(15), 0, 0)
...
# ==================== LEFT ARMREST ====================
# Create left armrest - thicker for more luxury feel
bpy.ops.mesh.primitive_cube_add(size=1, location=(-0.75, -0.15, 0.8))
left_armrest = bpy.context.active_object
left_armrest.name = "Left_Armrest"
left_armrest.scale = (0.3, 1.0, 0.7)

# Rotate to angle inward slightly
left_armrest.rotation_euler = (math.radians(10), 0, math.radians(-5))
...
# ==================== RIGHT ARMREST ====================
# Mirror for right armrest - thicker for more luxury feel
bpy.ops.mesh.primitive_cube_add(size=1, location=(0.75, -0.15, 0.8))
right_armrest = bpy.context.active_object
right_armrest.name = "Right_Armrest"
right_armrest.scale = (0.3, 1.0, 0.7)

# Rotate to angle inward slightly (mirrored)
right_armrest.rotation_euler = (math.radians(10), 0, math.radians(5))
...
# ==================== LEGS ====================
# Create 4 angled golden metal legs - slightly thicker for luxury look
# Front left leg
bpy.ops.mesh.primitive_cylinder_add(radius=0.035, depth=0.55, location=(-0.55, 0.45, 0.275))
...
empty.name = "Luxury_Leather_Armchair"
