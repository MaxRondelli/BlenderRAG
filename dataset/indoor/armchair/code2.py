...
leather_material = create_material("Leather_Brown", (0.35, 0.18, 0.08, 1.0), roughness=0.3)
# Black metal for legs
metal_material = create_material("Metal_Black", (0.05, 0.05, 0.05, 1.0), roughness=0.2, metallic=0.9)

# ==================== SEAT BASE ====================
# Create the main seat cushion - wider and thicker
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, 0, 0.5))
seat = bpy.context.active_object
seat.name = "Seat_Cushion"
seat.scale = (2.0, 2.0, 0.7)
...
# ==================== LEFT ARMREST ====================
# Create left armrest - thicker and more substantial
bpy.ops.mesh.primitive_cube_add(size=1, location=(-0.85, -0.15, 0.8))
left_armrest = bpy.context.active_object
left_armrest.name = "Left_Armrest"
left_armrest.scale = (0.35, 1.1, 0.7)
...
# ==================== RIGHT ARMREST ====================
# Mirror for right armrest - thicker and more substantial
bpy.ops.mesh.primitive_cube_add(size=1, location=(0.85, -0.15, 0.8))
right_armrest = bpy.context.active_object
right_armrest.name = "Right_Armrest"
right_armrest.scale = (0.35, 1.1, 0.7)
...
# ==================== LEGS ====================
# Create 4 angled metal legs - adjusted for thicker seat
# Front left leg
bpy.ops.mesh.primitive_cylinder_add(radius=0.025, depth=0.6, location=(-0.6, 0.5, 0.3))
