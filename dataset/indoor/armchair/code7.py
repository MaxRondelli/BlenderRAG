...
leather_material = create_material("Leather_Brown", (0.35, 0.2, 0.1, 1.0), roughness=0.3)
# Dark bronze metal for legs
metal_material = create_material("Metal_Bronze", (0.4, 0.25, 0.15, 1.0), roughness=0.2, metallic=0.8)

# ==================== SEAT BASE ====================
# Create the main seat cushion - thicker and more luxurious
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, 0, 0.5))
seat = bpy.context.active_object
seat.name = "Seat_Cushion"
seat.scale = (1.8, 1.8, 0.65)
...
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, -0.65, 1.15))
backrest = bpy.context.active_object
backrest.name = "Backrest"
backrest.scale = (1.3, 0.22, 1.4)
...
# ==================== LEFT ARMREST ====================
# Create left armrest - wider and more substantial
bpy.ops.mesh.primitive_cube_add(size=1, location=(-0.8, -0.15, 0.78))
left_armrest = bpy.context.active_object
left_armrest.name = "Left_Armrest"
left_armrest.scale = (0.32, 1.0, 0.7)
...
# ==================== RIGHT ARMREST ====================
# Mirror for right armrest - wider and more substantial
bpy.ops.mesh.primitive_cube_add(size=1, location=(0.8, -0.15, 0.78))
right_armrest = bpy.context.active_object
right_armrest.name = "Right_Armrest"
right_armrest.scale = (0.32, 1.0, 0.7)
...
# ==================== LEGS ====================
# Create 4 angled metal legs with bronze finish
# Front left leg
bpy.ops.mesh.primitive_cylinder_add(radius=0.025, depth=0.55, location=(-0.58, 0.45, 0.275))
