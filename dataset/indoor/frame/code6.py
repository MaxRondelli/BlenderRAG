...
def create_photo_frame(
    ...
    frame_depth=0.08,     # Depth/thickness of frame (increased for vintage look)
    frame_width=0.05,     # Width of frame border (slightly wider)
    bevel_segments=4,     # Number of stepped bevels (increased for more ornate look)
    material_color=(0.8, 0.65, 0.3, 1.0)  # Antique brass color (RGBA)
):
    """
    ...
    # Create material for antique brass frame
    ...
    backing_bsdf.inputs['Base Color'].default_value = (0.95, 0.92, 0.85, 1.0)
...
if __name__ == "__main__":
    ...
    frame, backing, profile = create_photo_frame(
        ...
        frame_width=0.05,
        bevel_segments=4,
        material_color=(0.8, 0.65, 0.3, 1.0)  # Antique brass golden color
    )
