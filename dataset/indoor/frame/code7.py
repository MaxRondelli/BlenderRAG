...
def create_photo_frame(
    ...
    frame_width=0.05,     # Width of frame border - INCREASED
    bevel_segments=5,     # Number of stepped bevels - INCREASED
    material_color=(0.8, 0.65, 0.2, 1.0)  # Gold color (RGBA) - CHANGED
):
    """
    ...
    # Create material for gilded frame - CHANGED TO METALLIC
    ...
    bsdf.inputs['Metallic'].default_value = 0.85  # ADDED METALLIC PROPERTY
    bsdf.inputs['Roughness'].default_value = 0.15  # REDUCED ROUGHNESS FOR SHINE
    ...
    backing_bsdf.inputs['Base Color'].default_value = (0.9, 0.9, 0.85, 1.0)
...
if __name__ == "__main__":
    ...
    frame, backing, profile = create_photo_frame(
        ...
        frame_width=0.05,
        bevel_segments=5,
        material_color=(0.9, 0.7, 0.25, 1.0)  # Rich gold color
    )
