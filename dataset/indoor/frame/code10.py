...
def create_photo_frame(
    ...
    frame_width=0.025,    # Width of frame border - thinner
    bevel_segments=2,     # Number of stepped bevels - reduced for cleaner look
    material_color=(0.2, 0.22, 0.25, 1.0)  # Dark gunmetal color (RGBA)
):
    """
    ...
    profile_points.append((frame_width, frame_depth - 0.003))
    profile_points.append((0, frame_depth - 0.003))
    profile_points.append((0, 0))
    ...
    # Create material for metal frame
...
if __name__ == "__main__":
    ...
    frame, backing, profile = create_photo_frame(
        ...
        frame_width=0.025,
        bevel_segments=2,
        material_color=(0.18, 0.2, 0.23, 1.0)  # Dark gunmetal color
    )
