...
def create_photo_frame(
    ...
    bevel_segments=3,     # Number of stepped bevels
    ...
    bsdf.inputs['Roughness'].default_value = 0.2  # Reduced for more polished look
    bsdf.inputs['Metallic'].default_value = 0.15  # Added metallic property
...
if __name__ == "__main__":
    ...
    frame, backing, profile = create_photo_frame(
        ...
        outer_height=0.4,
        frame_depth=0.05,
        frame_width=0.06,  # Increased frame width
        bevel_segments=3,
        material_color=(0.35, 0.15, 0.08, 1.0)  # Dark mahogany color
    )
