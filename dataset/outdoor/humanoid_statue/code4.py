...
l_shoulder = add_sphere("L_Shoulder", (-0.22, 0, 1.3), 0.095)
r_shoulder = add_sphere("R_Shoulder", (0.22, 0, 1.3), 0.095)

# Upper arms (increased radius by 20% for muscular build)
...
# Forearms (increased radius by 15% for muscular build)
...
# Upper legs (increased radius by 18% for muscular build)
l_upper_leg = add_cylinder("L_UpperLeg", (-0.11, 0, 0.65), 0.083, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.11, 0, 0.65), 0.083, 0.4)

# Lower legs (increased radius by 15% for muscular build)
l_lower_leg = add_cylinder("L_LowerLeg", (-0.11, 0, 0.3), 0.063, 0.35)
r_lower_leg = add_cylinder("R_LowerLeg", (0.11, 0, 0.3), 0.063, 0.35)
...
color_ramp.color_ramp.elements[0].color = (0.6, 0.35, 0.15, 1)
color_ramp.color_ramp.elements[1].color = (0.8, 0.55, 0.25, 1)

tex_coord = nodes.new(type='ShaderNodeTexCoord')
tex_coord.location = (-800, 0)

# Bronze principled settings
principled.inputs['Base Color'].default_value = (0.7, 0.45, 0.2, 1)
