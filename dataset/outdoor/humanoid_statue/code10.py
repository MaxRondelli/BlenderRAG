...
# Torso (upper and lower) - more muscular
chest = add_sphere("Chest", (0, 0, 1.3), 0.20)
chest.scale = (1.1, 0.7, 1.2)

belly = add_sphere("Belly", (0, 0, 1.05), 0.18)
belly.scale = (1.05, 0.7, 1)

# Shoulders - more muscular
l_shoulder = add_sphere("L_Shoulder", (-0.22, 0, 1.3), 0.09)
r_shoulder = add_sphere("R_Shoulder", (0.22, 0, 1.3), 0.09)

# Upper arms - 15% larger radius for athletic build
l_upper_arm = add_cylinder("L_UpperArm", (-0.3, 0, 1.1), 0.0575, 0.35, (0, radians(10), 0))
r_upper_arm = add_cylinder("R_UpperArm", (0.3, 0, 1.1), 0.0575, 0.35, (0, radians(-10), 0))

# Forearms - 15% larger radius
l_forearm = add_cylinder("L_Forearm", (-0.35, 0, 0.85), 0.046, 0.3, (0, radians(5), 0))
r_forearm = add_cylinder("R_Forearm", (0.35, 0, 0.85), 0.046, 0.3, (0, radians(-5), 0))

# Hands
l_hand = add_sphere("L_Hand", (-0.37, 0, 0.68), 0.055)
r_hand = add_sphere("R_Hand", (0.37, 0, 0.68), 0.055)

# Hips - more muscular
hips = add_sphere("Hips", (0, 0, 0.9), 0.19)
hips.scale = (1.15, 0.7, 0.8)

# Upper legs - 15% larger radius
l_upper_leg = add_cylinder("L_UpperLeg", (-0.11, 0, 0.65), 0.0805, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.11, 0, 0.65), 0.0805, 0.4)

# Lower legs - 15% larger radius
l_lower_leg = add_cylinder("L_LowerLeg", (-0.11, 0, 0.3), 0.0633, 0.35)
r_lower_leg = add_cylinder("R_LowerLeg", (0.11, 0, 0.3), 0.0633, 0.35)

# Feet
l_foot = add_sphere("L_Foot", (-0.11, 0.05, 0.08), 0.075)
l_foot.scale = (1, 1.5, 0.8)
r_foot = add_sphere("R_Foot", (0.11, 0.05, 0.08), 0.075)
...
color_ramp.color_ramp.elements[0].color = (0.45, 0.25, 0.12, 1)
color_ramp.color_ramp.elements[1].color = (0.65, 0.35, 0.18, 1)
...
print("✓ Athletic bronze statue created!")
