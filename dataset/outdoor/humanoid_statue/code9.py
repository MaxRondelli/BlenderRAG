...
l_shoulder = add_sphere("L_Shoulder", (-0.22, 0, 1.3), 0.10)
r_shoulder = add_sphere("R_Shoulder", (0.22, 0, 1.3), 0.10)

# Upper arms - 25% larger for athletic build
l_upper_arm = add_cylinder("L_UpperArm", (-0.3, 0, 1.1), 0.0625, 0.35, (0, radians(10), 0))
r_upper_arm = add_cylinder("R_UpperArm", (0.3, 0, 1.1), 0.0625, 0.35, (0, radians(-10), 0))

# Forearms - 25% larger for athletic build
l_forearm = add_cylinder("L_Forearm", (-0.35, 0, 0.85), 0.05, 0.3, (0, radians(5), 0))
r_forearm = add_cylinder("R_Forearm", (0.35, 0, 0.85), 0.05, 0.3, (0, radians(-5), 0))
...
# Upper legs - 30% larger for athletic build
l_upper_leg = add_cylinder("L_UpperLeg", (-0.11, 0, 0.65), 0.091, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.11, 0, 0.65), 0.091, 0.4)

# Lower legs - 25% larger for athletic build
l_lower_leg = add_cylinder("L_LowerLeg", (-0.11, 0, 0.3), 0.069, 0.35)
r_lower_leg = add_cylinder("R_LowerLeg", (0.11, 0, 0.3), 0.069, 0.35)
...
color_ramp.color_ramp.elements[0].color = (0.6, 0.35, 0.18, 1)
color_ramp.color_ramp.elements[1].color = (0.8, 0.45, 0.22, 1)

tex_coord = nodes.new(type='ShaderNodeTexCoord')
tex_coord.location = (-800, 0)

# Principled settings for bronze
principled.inputs["Base Color"].default_value = (0.7, 0.4, 0.2, 1)
...
print("✓ Athletic bronze humanoid statue created!")
