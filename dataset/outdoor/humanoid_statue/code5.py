...
# Torso (upper and lower) - increased width by 20%
chest = add_sphere("Chest", (0, 0, 1.3), 0.18)
chest.scale = (1.2, 0.84, 1.2)

belly = add_sphere("Belly", (0, 0, 1.05), 0.16)
belly.scale = (1.2, 0.84, 1)

# Shoulders
l_shoulder = add_sphere("L_Shoulder", (-0.22, 0, 1.3), 0.08)
r_shoulder = add_sphere("R_Shoulder", (0.22, 0, 1.3), 0.08)

# Upper arms - increased radius by 15%
...
# Forearms - increased radius by 10%
l_forearm = add_cylinder("L_Forearm", (-0.35, 0, 0.85), 0.044, 0.3, (0, radians(5), 0))
r_forearm = add_cylinder("R_Forearm", (0.35, 0, 0.85), 0.044, 0.3, (0, radians(-5), 0))

# Hands
l_hand = add_sphere("L_Hand", (-0.37, 0, 0.68), 0.05)
r_hand = add_sphere("R_Hand", (0.37, 0, 0.68), 0.05)

# Hips - increased width by 20%
hips = add_sphere("Hips", (0, 0, 0.9), 0.17)
hips.scale = (1.32, 0.84, 0.8)

# Upper legs - increased radius by 10%
l_upper_leg = add_cylinder("L_UpperLeg", (-0.11, 0, 0.65), 0.077, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.11, 0, 0.65), 0.077, 0.4)

# Lower legs - increased radius by 10%
l_lower_leg = add_cylinder("L_LowerLeg", (-0.11, 0, 0.3), 0.0605, 0.35)
r_lower_leg = add_cylinder("R_LowerLeg", (0.11, 0, 0.3), 0.0605, 0.35)
...
color_ramp.color_ramp.elements[0].color = (0.35, 0.25, 0.12, 1)
color_ramp.color_ramp.elements[1].color = (0.55, 0.4, 0.18, 1)

tex_coord = nodes.new(type='ShaderNodeTexCoord')
tex_coord.location = (-800, 0)

# Principled settings for bronze
principled.inputs['Base Color'].default_value = (0.45, 0.32, 0.15, 1)
...
print("✓ Bronze athletic humanoid statue created!")
