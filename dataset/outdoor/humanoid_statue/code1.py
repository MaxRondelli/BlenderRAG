...
# Shoulders (increased for muscular build)
l_shoulder = add_sphere("L_Shoulder", (-0.22, 0, 1.3), 0.1)
r_shoulder = add_sphere("R_Shoulder", (0.22, 0, 1.3), 0.1)

# Upper arms (increased radius by 30% for muscular build)
l_upper_arm = add_cylinder("L_UpperArm", (-0.3, 0, 1.1), 0.065, 0.35, (0, radians(10), 0))
r_upper_arm = add_cylinder("R_UpperArm", (0.3, 0, 1.1), 0.065, 0.35, (0, radians(-10), 0))

# Forearms (increased radius by 25%)
...
# Upper legs (increased radius by 25% for athletic build)
l_upper_leg = add_cylinder("L_UpperLeg", (-0.11, 0, 0.65), 0.0875, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.11, 0, 0.65), 0.0875, 0.4)

# Lower legs (increased radius by 20%)
...
color_ramp.color_ramp.elements[0].color = (0.545, 0.271, 0.075, 1)
color_ramp.color_ramp.elements[1].color = (0.722, 0.451, 0.200, 1)

tex_coord = nodes.new(type='ShaderNodeTexCoord')
tex_coord.location = (-800, 0)

# Principled settings for bronze finish
principled.inputs['Metallic'].default_value = 0.9
principled.inputs['Roughness'].default_value = 0.15
principled.inputs['IOR'].default_value = 1.18
...
print("✓ Bronze muscular humanoid statue created!")
