...
# Neck (slightly thicker for athletic build)
neck = add_cylinder("Neck", (0, 0, 1.45), 0.06, 0.15)

# Torso (broader for athletic build)
chest = add_sphere("Chest", (0, 0, 1.3), 0.20)
chest.scale = (1.1, 0.8, 1.3)

belly = add_sphere("Belly", (0, 0, 1.05), 0.18)
belly.scale = (1.1, 0.8, 1.1)

# Shoulders (broader)
l_shoulder = add_sphere("L_Shoulder", (-0.24, 0, 1.3), 0.09)
r_shoulder = add_sphere("R_Shoulder", (0.24, 0, 1.3), 0.09)

# Upper arms (more muscular)
...
# Hands
l_hand = add_sphere("L_Hand", (-0.40, 0, 0.68), 0.05)
r_hand = add_sphere("R_Hand", (0.40, 0, 0.68), 0.05)

# Hips (broader for athletic build)
hips = add_sphere("Hips", (0, 0, 0.9), 0.19)
hips.scale = (1.2, 0.8, 0.9)

# Upper legs (more muscular)
l_upper_leg = add_cylinder("L_UpperLeg", (-0.12, 0, 0.65), 0.09, 0.4)
r_upper_leg = add_cylinder("R_UpperLeg", (0.12, 0, 0.65), 0.09, 0.4)

# Lower legs (more muscular)
l_lower_leg = add_cylinder("L_LowerLeg", (-0.12, 0, 0.3), 0.07, 0.35)
r_lower_leg = add_cylinder("R_LowerLeg", (0.12, 0, 0.3), 0.07, 0.35)

# Feet
l_foot = add_sphere("L_Foot", (-0.12, 0.05, 0.08), 0.07)
l_foot.scale = (1, 1.5, 0.8)
r_foot = add_sphere("R_Foot", (0.12, 0.05, 0.08), 0.07)
...
mat = bpy.data.materials.new(name="DarkBronze")
mat.use_nodes = True
...
color_ramp.color_ramp.elements[1].color = (0.35, 0.22, 0.12, 1)
...
print("✓ Athletic humanoid bronze statue created!")
