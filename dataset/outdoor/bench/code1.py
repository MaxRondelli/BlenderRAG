...
def create_wood_material():
    mat = bpy.data.materials.new("DarkWalnut")
    mat.use_nodes = True
    nodes = mat.node_tree.nodes
    nodes.clear()
    
    bsdf = nodes.new('ShaderNodeBsdfPrincipled')
    bsdf.inputs['Base Color'].default_value = (0.2, 0.12, 0.08, 1)
...
# SEDUTA - 5 listelli (50% più spessi)
seat_width = 2.4
seat_depth = 0.6
for i in range(5):
...
print("✓ Sleek modern bench with dark walnut and chrome finish created!")