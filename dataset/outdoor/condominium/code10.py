...
def mat_concrete():
    ...
    ramp.color_ramp.elements[0].color = (0.85, 0.55, 0.35, 1)
    ramp.color_ramp.elements[1].color = (0.92, 0.62, 0.42, 1)
...
def mat_concrete_dark():
    ...
    ramp = nodes.new('ShaderNodeValToRGB')
    ramp.color_ramp.elements[0].color = (0.72, 0.42, 0.25, 1)
    ramp.color_ramp.elements[1].color = (0.80, 0.50, 0.32, 1)
...
def mat_glass():
    ...
    safe_set(bsdf.inputs, 'Base Color', (0.95, 0.85, 0.65, 1))
...
def mat_metal_railing():
    ...
    mix.data_type = 'RGBA'
    mix.inputs[6].default_value = (0.15, 0.35, 0.20, 1)
    mix.inputs[7].default_value = (0.20, 0.45, 0.25, 1)
    
    links.new(mix.outputs['Result'], bsdf.inputs['Base Color'])
    
    safe_set(bsdf.inputs, 'Metallic', 0.85)
...
def mat_wood():
    ...
    ramp = nodes.new('ShaderNodeValToRGB')
    ramp.color_ramp.elements[0].color = (0.45, 0.28, 0.15, 1)
    ramp.color_ramp.elements[1].color = (0.65, 0.42, 0.25, 1)
...
print("✅ Mediterranean style condominium - F12 to render")
