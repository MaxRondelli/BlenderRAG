...
# CEMENTO TERRACOTTA CON TEXTURE
def mat_concrete():
    ...
    ramp.color_ramp.elements[0].color = (0.72, 0.45, 0.32, 1)
    ramp.color_ramp.elements[1].color = (0.82, 0.55, 0.42, 1)
...
def mat_concrete_dark():
    ...
    ramp = nodes.new('ShaderNodeValToRGB')
    ramp.color_ramp.elements[0].color = (0.58, 0.35, 0.22, 1)
    ramp.color_ramp.elements[1].color = (0.68, 0.45, 0.32, 1)
...
def mat_glass():
    ...
    safe_set(bsdf.inputs, 'Base Color', (0.92, 0.88, 0.82, 1))
...
def mat_metal_railing():
    ...
    mix.data_type = 'RGBA'
    mix.inputs[6].default_value = (0.92, 0.52, 0.35, 1)
    mix.inputs[7].default_value = (0.95, 0.62, 0.45, 1)
...
print("✅ Mediterranean modern architecture - F12 for render")
