...
# Aggiungi subdivision surface (aumentato per roccia più arrotondata)
...
# Displacement primario per forma grezza con spigoli (ridotto)
...
# Displacement secondario per parti taglienti (ridotto)
...
# Displacement terzo per micro-dettagli (ridotto)
...
# Materiale PBR con variazioni di colore
...
ramp_base.color_ramp.elements[0].color = (0.52, 0.35, 0.22, 1)  # Marrone rossastro
ramp_base.color_ramp.elements[1].color = (0.68, 0.58, 0.45, 1)  # Beige sabbioso
...
# Noise per bump (sostituisce Musgrave in Blender 4.x)
...
print("Rock weathered iperrealistico generato!")
