...
# Colore base cream-tan (limestone colors)
...
ramp_base.color_ramp.elements[0].color = (0.72, 0.68, 0.58, 1)  # Cream scuro
ramp_base.color_ramp.elements[1].color = (0.85, 0.78, 0.65, 1)  # Tan chiaro
...
print("Rock iperrealistico generato!")
