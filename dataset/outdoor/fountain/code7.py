...
color_ramp.color_ramp.elements[1].color = (0.45, 0.25, 0.1, 1.0)
...
# MATERIALE ACQUA OSSIDANTE
mat_water = bpy.data.materials.new(name="OxidizedWater")
mat_water.use_nodes = True
bsdf_water = mat_water.node_tree.nodes["Principled BSDF"]
bsdf_water.inputs['Base Color'].default_value = (0.15, 0.4, 0.35, 1.0)
...
# ANELLO INTERMEDIO - più robusto
bpy.ops.mesh.primitive_cylinder_add(radius=2.1, depth=0.25, location=(0, 0, 0.45))
mid_ring = bpy.context.active_object
mid_ring.name = "Mid_Ring"
mid_ring.data.materials.append(mat_bronze)

# PIEDISTALLO CENTRALE - più largo
bpy.ops.mesh.primitive_cylinder_add(radius=1.1, depth=1.6, location=(0, 0, 1.25))
pedestal = bpy.context.active_object
pedestal.name = "Pedestal"
pedestal.data.materials.append(mat_bronze)

# VASCA PRINCIPALE - base più spessa
bpy.ops.mesh.primitive_cylinder_add(radius=2.0, depth=0.3, location=(0, 0, 2.05))
...
bpy.ops.mesh.primitive_torus_add(major_radius=2.0, minor_radius=0.45, location=(0, 0, 2.25))
...
bpy.ops.mesh.primitive_cylinder_add(radius=1.85, depth=0.1, location=(0, 0, 2.15))
...
print("Fontana in bronzo scuro con proporzioni robuste creata!")
