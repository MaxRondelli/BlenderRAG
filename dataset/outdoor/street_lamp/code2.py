...
# Create materials
bronze_metal = create_metal_material("BronzeMetal", (0.4, 0.25, 0.15, 1.0))
...
for z in [0.05, 0.25]:
    bpy.ops.mesh.primitive_torus_add(major_radius=0.13, minor_radius=0.03, location=(0, 0, z))
...
# Volute decorative superiori (spirali ornamentali)
...
print("Vintage bronze street lamp generato con successo!")
