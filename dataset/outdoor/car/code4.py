...
# Create and assign materials (deep blue metallic for sports car)
body_mat = create_material("BodyMat", (0.1, 0.2, 0.8, 1.0), metallic=0.95, roughness=0.1)  # Deep blue metallic
