...
# Centro marrone-arancione (sunflower center)
...
# Petali gialli più grandi con punte dorate
...
coloramp.color_ramp.elements[0].color = (1.0, 0.8, 0.1, 1)
coloramp.color_ramp.elements[1].color = (0.9, 0.6, 0.0, 1)
...
output = nodes.new('ShaderNodeOutputMaterial')
mat_petalo.node_tree.links.new(coord.outputs['Generated'], mapping.inputs['Vector'])
mat_petalo.node_tree.links.new(coloramp.outputs['Color'], bsdf.inputs['Base Color'])
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.1*scale_factor, depth=2.5*scale_factor, location=(0, 0, -1.25*scale_factor), vertices=32)
...
bsdf = nodes.new('ShaderNodeBsdfPrincipled')
bsdf.inputs['Base Color'].default_value = (0.2, 0.6, 0.15, 1)
bsdf.inputs['Roughness'].default_value = 0.8
