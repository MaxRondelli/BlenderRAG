...
# Materiale ARANCIONE-ROSSO (autumn colors)
mat = bpy.data.materials.new("Autumn")
mat.use_nodes = True
...
# Distribute Points (increased density for fuller foliage)
distribute = nodes.new('GeometryNodeDistributePointsOnFaces')
distribute.distribute_method = 'RANDOM'
distribute.inputs['Density'].default_value = 8000
