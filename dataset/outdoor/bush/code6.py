...
# Materiale ARANCIO-ROSSO AUTUNNALE
mat = bpy.data.materials.new("AutumnLeaves")
mat.use_nodes = True
...
distribute.inputs['Density'].default_value = 5000
...
print("Cespuglio autunnale con foglie arancio-rosse!")
