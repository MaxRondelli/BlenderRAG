...
def crea_materiale_tessuto():
    ...
    color_ramp = nodes.new('ShaderNodeValToRGB')
    color_ramp.color_ramp.elements[0].color = (0.05, 0.75, 0.85, 1)
    color_ramp.color_ramp.elements[1].color = (0.95, 0.85, 0.15, 1)
...
print("Ombrellone tropicale con strisce turchesi e gialle!")