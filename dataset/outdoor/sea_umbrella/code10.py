...
def crea_materiale_legno():
    ...
    color_ramp.color_ramp.elements[1].color = (0.25, 0.15, 0.08, 1)
...
# Tavolo
bpy.ops.mesh.primitive_cylinder_add(vertices=64, radius=0.75, depth=0.1, location=(0, 0, 0.3))
...
bpy.ops.mesh.primitive_cylinder_add(vertices=32, radius=0.03, depth=2.8, location=(centro_x, centro_y, 1.4))
