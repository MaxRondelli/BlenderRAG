...
def crea_materiale_tessuto():
    ...
    color_ramp = nodes.new('ShaderNodeValToRGB')
    color_ramp.color_ramp.elements[0].color = (0.1, 0.4, 0.8, 1)
    color_ramp.color_ramp.elements[1].color = (0.95, 0.95, 0.95, 1)
...
def crea_materiale_metallo():
    ...
    bsdf = nodes.new('ShaderNodeBsdfPrincipled')
    bsdf.inputs['Base Color'].default_value = (0.5, 0.5, 0.55, 1)
...
# Tavolo
bpy.ops.mesh.primitive_cylinder_add(vertices=64, radius=0.75, depth=0.1, location=(0, 0, 0.32))
...
bpy.ops.mesh.primitive_cylinder_add(vertices=32, radius=0.03, depth=2.9, location=(centro_x, centro_y, 1.45))
...
# Camera
bpy.ops.object.camera_add(location=(5.2, -4.8, 3.0))
...
sole.rotation_euler = (math.radians(40), math.radians(15), math.radians(120))
