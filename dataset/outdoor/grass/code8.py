...
# Grass material with autumn gradient
...
ramp.color_ramp.elements[0].color = (0.25, 0.15, 0.05, 1)
ramp.color_ramp.elements[1].color = (0.85, 0.75, 0.25, 1)
...
print("✓ Autumn grass with golden-yellow gradient and wheat-like appearance!")
