...
# Winter grass material with frost gradient
mat_grass = bpy.data.materials.new("WinterGrassMat")
...
# Winter frost color gradient: muted blue-green base to silvery white tips
ramp.color_ramp.elements[0].color = (0.15, 0.25, 0.22, 1)
ramp.color_ramp.elements[1].color = (0.85, 0.90, 0.95, 1)

mat_grass.node_tree.links.new(coord.outputs['Object'], separate.inputs[0])
mat_grass.node_tree.links.new(separate.outputs['Z'], ramp.inputs['Fac'])
...
print("✓ Winter grass with frost-tipped blades - dormant season!")
