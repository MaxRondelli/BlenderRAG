...
bsdf.inputs['Base Color'].default_value = (0.15, 0.10, 0.05, 1)
...
# Autumn grass material with gradient
...
ramp.color_ramp.elements[1].color = (0.8, 0.5, 0.2, 1)
...
print("✓ Autumn grass with warm colors and sparse distribution!")
