...
# Move vertices for curvature (more pronounced for autumn wind-bent effect)
for i, vert in enumerate(grass_blade.data.vertices):
    if vert.co.z > 0.1:
        vert.co.x += 0.12 * vert.co.z * vert.co.z
        vert.co.z *= 0.85
...
ramp.color_ramp.elements[0].color = (0.25, 0.15, 0.06, 1)
ramp.color_ramp.elements[1].color = (0.8, 0.55, 0.25, 1)
...
print("✓ Autumn grass with golden-brown gradients and wind-bent blades!")
